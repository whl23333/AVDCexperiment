...
class Encoder(BaseEncoder):
    ...
    def __init__(self, hidden_size, activation_function='relu', ch=3, robot=False):
        ...
        self.conv5 = nn.Conv2d(256, 512, 4, stride=2, padding=1, groups=g)
        self.conv5_2 = nn.Conv2d(512, 512, 4, stride=1, padding=1, groups=g)
    ...
    def forward(self, observations):
        ...
        hidden = self.act_fn(self.conv5(hidden))
        hidden = self.act_fn(self.conv5_2(hidden))
